...
[説明書](./PhotoReportMaker/manual/Photo_report_maker_first_step.html)  
[Excel変換用のテンプレート編集方法](./PhotoReportMaker/manual/EditExcelTemplate.html)
...
最新機種にはセキュリティーの関係で対応していません。親切な人が対応のヒントをくれたのですが、手段が一般ユーザーには無理だし、それはやっちゃいかんだろと思って手を出していません。そもそも最新機種は、標準で機能拡張できるし、このアプリは要らないんじゃないかと。
...
ウィンドウズ用のビューアは標準であるのですが、Android用はないので作りましたというか、そんな需要があるのかわかりません。おまけに古い機種ですし。たまたま録画ファイルを解析して資料が残っていたので作ったみたいな感じです。いろいろ勉強になりました（jpeg2000とか）。
